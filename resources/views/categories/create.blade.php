...
<head>
    ...
    <title>បន្ថែមប្រភេទសៀវភៅថ្មី - Dashboard</title>
    ...
    <div class="d-flex">
        <div class="sidebar bg-dark text-white d-none d-md-flex flex-column p-3">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a href="{{ route('authors.create') }}" class="nav-link"><i class="bi bi-person-badge me-2"></i> អ្នកនិពន្ធ</a></li>
                <li><a href="#" class="nav-link active"><i class="bi bi-tags me-2"></i> ប្រភេទសៀវភៅ</a></li>
            </ul>
        </div>

        <div class="main-content">
            <nav class="navbar navbar-white bg-white border-bottom sticky-top shadow-sm py-3 px-4">
                <span class="fw-bold text-dark"><i class="bi bi-tags me-2"></i>ការគ្រប់គ្រងប្រភេទសៀវភៅ</span>
            </nav>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="card shadow border-0 rounded-3">
                            <div class="card-header bg-info text-dark py-3 border-0">
                                <h5 class="mb-0 fw-bold"><i class="bi bi-tag-fill me-2"></i>បង្កើតប្រភេទសៀវភៅថ្មី (Create Category)</h5>
                            </div>
                            <div class="card-body p-4">
                                <form action="{{ route('categories.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-secondary">ឈ្មោះប្រភេទសៀវភៅ (Category Name)</label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light text-muted"><i class="bi bi-bookmark-plus"></i></span>
                                            <input type="text" name="name" class="form-control" required placeholder="ឧទាហរណ៍៖ ប្រលោមលោក, វិទ្យាសាស្ត្រ...">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between pt-2 border-top">
                                        <a href="{{ route('books.ui') }}" class="btn btn-light border text-secondary px-4">បោះបង់</a>
                                        <button type="submit" class="btn btn-info px-4 fw-bold shadow-sm">រក្សាទុកទិន្នន័យ</button>
                                    </div>
                                </form>
                            </div>
                        </div>
