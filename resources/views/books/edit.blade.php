...
<head>
    ...
    <title>កែប្រែទិន្នន័យសៀវភៅ - Dashboard</title>
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                                    ...
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-gear me-2"></i> การกำหนด</a></li>
                                    <li><hr class="dropdown-divider"></li>
                    ...
                    <div class="col-12 col-lg-7">
                        ...
                        <div class="card shadow border-0 rounded-3">
                            <div class="card-header bg-warning text-dark py-3 border-0">
                                <h5 class="mb-0 fw-bold"><i class="bi bi-pencil-square me-2"></i>កែប្រែទិន្នន័យសៀវភៅ</h5>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <form action="{{ route('books.update', $book->id) }}" method="POST">
                                    ...
                                    <div class="d-flex justify-content-between pt-2 border-top">
                                        <a href="{{ route('books.ui') }}" class="btn btn-light px-4 fw-semibold border text-secondary">បោះបង់</a>
